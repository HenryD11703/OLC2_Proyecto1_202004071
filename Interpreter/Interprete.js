        ...
        switch (node.op) {
            case '+':
                ...
                if (izq.tipo === 'int' && der.tipo === 'int') {
                    ...
                    console.log('Error de tipos: no se puede sumar ' + izq.tipo +' con ' + der.tipo);
                    return { tipo: null, valor: null };
                }
            case '-':
                // Para la resta:
                ...
                if (izq.tipo === 'int' && der.tipo === 'int') {
                    ...
                    console.log('Error de tipos: no se puede restar'+ izq.tipo +' con'+ der.tipo);
                    return { tipo: null, valor: null };
                }
            case '*':
                ...
                if (izq.tipo === 'int' && der.tipo === 'int') {
                    ...
                    console.log('Error de tipos: no se puede multiplicar'+ izq.tipo +' con'+ der.tipo);
                    return { tipo: null, valor: null };
                }
            case '/':
                ...
                if (izq.tipo === 'int' && der.tipo === 'int') {
                    ...
                    console.log('Error de tipos: no se puede dividir'+ izq.tipo +' con'+ der.tipo);
                    return { tipo: null, valor: null };
                }
            case '||':
                // return Boolean(izq.valor) || Boolean(der.valor);
                return { tipo: 'boolean', valor: Boolean(izq.valor) || Boolean(der.valor) };
            case '&&':
                // return Boolean(izq.valor) && Boolean(der.valor);
                return { tipo: 'boolean', valor: Boolean(izq.valor) && Boolean(der.valor) };
            case '==':
                // return izq.valor === der.valor;
                return new Nativo({ tipo: 'boolean', valor: izq.valor === der.valor });
            case '!=':
                // return izq.valor !== der.valor;
                return new Nativo({ tipo: 'boolean', valor: izq.valor!== der.valor });
            case '>':
            ...
            case '%':
                ...
                if (izq.tipo === 'int' && der.tipo === 'int') {
                    ...
                    console.log('Error de tipos: no se puede calcular el modulo entre'+ izq.tipo +' y'+ der.tipo);
                    return { tipo: null, valor: null };
                }
            default:
        ...
        switch (node.op) {
            case '-':
                ...
                if (exp.tipo === 'int') {
                    ...
                    console.log('Error de tipos: no se puede hacer negacion a '+ exp.tipo);
                    return { tipo: null, valor: null };
                }
            case '!':
                // return !exp;
