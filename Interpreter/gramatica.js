...
function peg$parse(input, options) {
  ...
  var peg$f7 = function(texto) { return crearNodo('cadena', texto) };
  ...
  var peg$f20 = function(tipo, exp) { return crearNodo('unaria', { op:tipo, exp})};
  var peg$f21 = function() { return crearNodo('numero', { valor: parseFloat(text(),10)}) };
  var peg$f22 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f23 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f24 = function(id) { return crearNodo('accesoVar', {id}) };
